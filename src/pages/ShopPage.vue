...
<style scoped>
.shop-page { display:flex;flex-direction:column;overflow:hidden;padding-bottom:0;background: radial-gradient(circle at 0 0,rgba(236,218,223,.55),transparent 27%),linear-gradient(180deg,#fbf8f4,#f5f3ef 62%,#eef3ef); }
.shop-header { flex:none;display:grid; grid-template-columns:40px minmax(0,1fr) 40px; align-items:center; min-height:calc(68px + var(--safe-top)); padding:calc(12px + var(--safe-top)) calc(15px + var(--safe-right)) 6px calc(15px + var(--safe-left)); }
...
.shop-content { flex:1;min-height:0;height:auto;padding:8px 15px calc(38px + var(--safe-bottom));overflow-y:auto;overscroll-behavior:contain; }
